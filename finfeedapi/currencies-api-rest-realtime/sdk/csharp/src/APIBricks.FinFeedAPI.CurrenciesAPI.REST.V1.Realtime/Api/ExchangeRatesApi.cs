    ...
    public sealed partial class ExchangeRatesApi : IExchangeRatesApi
    {
        ...
        public partial class GetSpecificRateApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Client.ApiResponse, IGetSpecificRateApiResponse
        {
            ...
            public APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRate? Ok()
            {
                ...
                APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRate? result = null;
            ...
            private APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRate? DefaultOk()
            {
            ...
            partial void OnOk(ref bool suppressDefault, ref APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRate? result);
        ...
        public partial class V1ExchangerateAssetIdBaseGetApiResponse : APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Client.ApiResponse, IV1ExchangerateAssetIdBaseGetApiResponse
        {
            ...
            {
                bool suppressDefault = false;
                APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRates? result = null;
                OnOk(ref suppressDefault, ref result);
                if (!suppressDefault)
                    result = DefaultOk();
                return result;
            ...
            private APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRates? DefaultOk()
            {
                // NOTICE: Consider this AsModel template deprecated. Implement the appropriate partial method instead
                return IsOk
            ...
            partial void OnOk(ref bool suppressDefault, ref APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRates? result);
