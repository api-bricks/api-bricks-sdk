...
namespace APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Test.Api
{
    ...
    public sealed class ExchangeRatesApiTests : ApiTestsBase
    {
        ...
        public async Task GetSpecificRateAsyncTest()
        {
            ...
            Assert.IsType<APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRate>(model);
        }
        ...
        public async Task V1ExchangerateAssetIdBaseGetAsyncTest()
        {
            ...
            var model = response.Ok();
            Assert.IsType<APIBricks.FinFeedAPI.CurrenciesAPI.REST.V1.Realtime.Model.V1ExchangeRates>(model);
        }
    }
}
