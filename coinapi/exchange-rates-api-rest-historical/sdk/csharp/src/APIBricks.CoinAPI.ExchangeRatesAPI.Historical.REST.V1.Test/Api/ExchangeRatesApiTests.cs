...
namespace APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1.Test.Api
{
    ...
    public sealed class ExchangeRatesApiTests : ApiTestsBase
    {
        ...
        public async Task GetSpecificRateAsyncTest()
        {
            ...
            Assert.IsType<APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1.Model.V1ExchangeRate>(model);
        }
        ...
        public async Task V1ExchangerateAssetIdBaseGetAsyncTest()
        {
            ...
            var model = response.Ok();
            Assert.IsType<APIBricks.CoinAPI.ExchangeRatesAPI.Historical.REST.V1.Model.V1ExchangeRates>(model);
        }
