...
void main() {
  ...
  group(MetadataApi, () {
    ...
    //
    //Future<BuiltList<MarketDataMetadataAsset>> v1AssetsGet({ String filterAssetId, String filterAssetType }) async
    ...
    //
    //Future<BuiltList<MarketDataMetadataSymbol>> v1SymbolsExchangeIdUnmappedGet(String exchangeId, { int page, int limit }) async
