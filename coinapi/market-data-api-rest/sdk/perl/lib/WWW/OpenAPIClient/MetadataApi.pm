...
# @param string $exchange_symbol_id The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;). (required)
{
    ...
    'exchange_symbol_id' => {
        data_type => 'string',
        description => 'The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;).',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get' } = {
        summary => 'Get a single symbol by its exchange-native symbol identifier.',
        params => $params,
        returns => 'MarketDataMetadataSymbol',
        };
}
# @return MarketDataMetadataSymbol
#
sub v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get {
    my ($self, %args) = @_;

    # verify the required parameter 'exchange_id' is set
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get");
    }

    # verify the required parameter 'exchange_symbol_id' is set
    unless (exists $args{'exchange_symbol_id'}) {
      croak("Missing the required parameter 'exchange_symbol_id' when calling v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get");
    }

    # parse inputs
    my $_resource_path = '/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}';
    ...
    # path params
    if ( exists $args{'exchange_symbol_id'}) {
        my $_base_variable = "{" . "exchange_symbol_id" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'exchange_symbol_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('MarketDataMetadataSymbol', $response);
    return $_response_object;
}
...
# @param int $limit Number of records to return per page. (optional, default to 100)
{
    ...
    __PACKAGE__->method_documentation->{ 'v1_symbols_exchange_id_unmapped_get' } = {
...
# @return ARRAY[MarketDataMetadataSymbol]
#
sub v1_symbols_exchange_id_unmapped_get {
    my ($self, %args) = @_;

    # verify the required parameter 'exchange_id' is set
    unless (exists $args{'exchange_id'}) {
      croak("Missing the required parameter 'exchange_id' when calling v1_symbols_exchange_id_unmapped_get");
    }

    # parse inputs
    my $_resource_path = '/v1/symbols/{exchange_id}/unmapped';
