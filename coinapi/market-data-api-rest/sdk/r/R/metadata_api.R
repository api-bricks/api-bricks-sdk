...
MetadataApi <- R6::R6Class(
  ...
  public = list(
    ...
    V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet = function(exchange_id, exchange_symbol_id, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetWithHttpInfo(exchange_id, exchange_symbol_id, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #' @param .parse Logical. If \code{TRUE} then the response will be parsed to a generated type. If \code{FALSE} the response will be returned as unparsed text.
    #'
    #' @return API response (MarketDataMetadataSymbol) with additional information such as HTTP status code, headers
    V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetWithHttpInfo = function(exchange_id, exchange_symbol_id, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (missing(`exchange_symbol_id`)) {
        stop("Missing required parameter `exchange_symbol_id`.")
      }

      if (!missing(`exchange_id`) && is.null(`exchange_id`)) {
        stop("Invalid value for `exchange_id` when calling MetadataApi$V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet, `exchange_id` is not nullable")
      }

      if (!missing(`exchange_symbol_id`) && is.null(`exchange_symbol_id`)) {
        stop("Invalid value for `exchange_symbol_id` when calling MetadataApi$V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet, `exchange_symbol_id` is not nullable")
      }

      local_var_url_path <- "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}"
      if (!missing(`exchange_id`)) {
        local_var_url_path <- gsub("\\{exchange_id\\}", URLencode(as.character(`exchange_id`), reserved = TRUE), local_var_url_path)
      }

      if (!missing(`exchange_symbol_id`)) {
        local_var_url_path <- gsub("\\{exchange_symbol_id\\}", URLencode(as.character(`exchange_symbol_id`), reserved = TRUE), local_var_url_path)
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "MarketDataMetadataSymbol"),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    #'
    #' @return array[MarketDataMetadataSymbol]
    V1SymbolsExchangeIdUnmappedGet = function(exchange_id, page = 1, limit = 100, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$V1SymbolsExchangeIdUnmappedGetWithHttpInfo(exchange_id, page, limit, data_file = data_file, ..., .parse = .parse)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    #'
    #' @return API response (array[MarketDataMetadataSymbol]) with additional information such as HTTP status code, headers
    V1SymbolsExchangeIdUnmappedGetWithHttpInfo = function(exchange_id, page = 1, limit = 100, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`exchange_id`) && is.null(`exchange_id`)) {
        stop("Invalid value for `exchange_id` when calling MetadataApi$V1SymbolsExchangeIdUnmappedGet, `exchange_id` is not nullable")
      }

      if (!missing(`page`) && is.null(`page`)) {
        stop("Invalid value for `page` when calling MetadataApi$V1SymbolsExchangeIdUnmappedGet, `page` is not nullable")
      }

      if (!missing(`limit`) && is.null(`limit`)) {
        stop("Invalid value for `limit` when calling MetadataApi$V1SymbolsExchangeIdUnmappedGet, `limit` is not nullable")
      }
      ...
      local_var_url_path <- "/v1/symbols/{exchange_id}/unmapped"
      if (!missing(`exchange_id`)) {
        local_var_url_path <- gsub("\\{exchange_id\\}", URLencode(as.character(`exchange_id`), reserved = TRUE), local_var_url_path)
      }
