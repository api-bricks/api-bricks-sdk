...
func Test_openapi_MetadataAPIService(t *testing.T) {
	...
	t.Run("Test MetadataAPIService V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var exchangeId string
		var exchangeSymbolId string

		resp, httpRes, err := apiClient.MetadataAPI.V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(context.Background(), exchangeId, exchangeSymbolId).Execute()
	...
	t.Run("Test MetadataAPIService V1SymbolsExchangeIdUnmappedGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var exchangeId string

		resp, httpRes, err := apiClient.MetadataAPI.V1SymbolsExchangeIdUnmappedGet(context.Background(), exchangeId).Execute()
