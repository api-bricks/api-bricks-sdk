...
namespace APIBricks.CoinAPI.MarketDataAPI.REST.V1.Api
{
    ...
    public interface IMetadataApi : IApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>&gt;</returns>
        Task<IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse> V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsync(string exchangeId, string exchangeSymbolId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>?&gt;</returns>
        Task<IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse?> V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetOrDefaultAsync(string exchangeId, string exchangeSymbolId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="limit">Number of records to return per page. (optional, default to 100)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdUnmappedGetApiResponse"/>&gt;</returns>
        Task<IV1SymbolsExchangeIdUnmappedGetApiResponse> V1SymbolsExchangeIdUnmappedGetAsync(string exchangeId, Option<int> page = default, Option<int> limit = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdUnmappedGetApiResponse"/>?&gt;</returns>
        Task<IV1SymbolsExchangeIdUnmappedGetApiResponse?> V1SymbolsExchangeIdUnmappedGetOrDefaultAsync(string exchangeId, Option<int> page = default, Option<int> limit = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// <summary>
    /// The <see cref="IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>
    /// </summary>
    public interface IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.IApiResponse, IOk<APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// <summary>
    /// The <see cref="IV1SymbolsExchangeIdUnmappedGetApiResponse"/>
    /// </summary>
    public interface IV1SymbolsExchangeIdUnmappedGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.IApiResponse, IOk<List<MarketDataMetadataSymbol>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public class MetadataApiEvents
    {
        ...
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet;

        internal void ExecuteOnV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(MetadataApi.V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse apiResponse)
        {
            OnV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(Exception exception)
        {
            OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet?.Invoke(this, new ExceptionEventArgs(exception));
        }
        ...
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnV1SymbolsExchangeIdUnmappedGet;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorV1SymbolsExchangeIdUnmappedGet;

        internal void ExecuteOnV1SymbolsExchangeIdUnmappedGet(MetadataApi.V1SymbolsExchangeIdUnmappedGetApiResponse apiResponse)
        {
            OnV1SymbolsExchangeIdUnmappedGet?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorV1SymbolsExchangeIdUnmappedGet(Exception exception)
        {
            OnErrorV1SymbolsExchangeIdUnmappedGet?.Invoke(this, new ExceptionEventArgs(exception));
        }
    ...
    public sealed partial class MetadataApi : IMetadataApi
    {
        ...
        partial void FormatV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref string exchangeId, ref string exchangeSymbolId);

        /// <summary>
        /// Validates the request parameters
        /// </summary>
        /// <param name="exchangeId"></param>
        /// <param name="exchangeSymbolId"></param>
        /// <returns></returns>
        private void ValidateV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(string exchangeId, string exchangeSymbolId)
        {
            if (exchangeId == null)
                throw new ArgumentNullException(nameof(exchangeId));

            if (exchangeSymbolId == null)
                throw new ArgumentNullException(nameof(exchangeSymbolId));
        }
        ...
        /// <param name="exchangeId"></param>
        /// <param name="exchangeSymbolId"></param>
        private void AfterV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetDefaultImplementation(IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse apiResponseLocalVar, string exchangeId, string exchangeSymbolId)
        {
            bool suppressDefaultLog = false;
            AfterV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref suppressDefaultLog, apiResponseLocalVar, exchangeId, exchangeSymbolId);
            if (!suppressDefaultLog)
                Logger.LogInformation(RestLogEvents.ApiRequestCompleted, "{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="exchangeId"></param>
        /// <param name="exchangeSymbolId"></param>
        partial void AfterV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref bool suppressDefaultLog, IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse apiResponseLocalVar, string exchangeId, string exchangeSymbolId);
        ...
        /// <param name="exchangeId"></param>
        /// <param name="exchangeSymbolId"></param>
        private void OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string exchangeId, string exchangeSymbolId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, exchangeId, exchangeSymbolId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(RestLogEvents.ApiRequestFailed, exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="exchangeId"></param>
        /// <param name="exchangeSymbolId"></param>
        partial void OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string exchangeId, string exchangeSymbolId);

        /// <summary>
        /// Get a single symbol by its exchange-native symbol identifier. Looks up a symbol by &#x60;symbol_id_exchange&#x60; regardless of mapping status - this also returns symbols that have not been mapped to a CoinAPI &#x60;symbol_id&#x60; yet (see &#x60;{exchange_id}/unmapped&#x60;).
        /// </summary>
        /// <param name="exchangeId">The ID of the exchange.</param>
        /// <param name="exchangeSymbolId">The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;).</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>&gt;</returns>
        public async Task<IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse?> V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetOrDefaultAsync(string exchangeId, string exchangeSymbolId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsync(exchangeId, exchangeSymbolId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>&gt;</returns>
        public async Task<IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse> V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsync(string exchangeId, string exchangeSymbolId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(exchangeId, exchangeSymbolId);

                FormatV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(ref exchangeId, ref exchangeSymbolId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}");
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7Bexchange_id%7D", Uri.EscapeDataString(exchangeId.ToString()));
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7Bexchange_symbol_id%7D", Uri.EscapeDataString(exchangeSymbolId.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(Logger, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}", requestedAtLocalVar, _jsonSerializerOptions);

                                break;
                            }
                        }

                        AfterV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetDefaultImplementation(apiResponseLocalVar, exchangeId, exchangeSymbolId);

                        Events.ExecuteOnV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(apiResponseLocalVar);
            ...
            {
                OnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetDefaultImplementation(e, "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}", uriBuilderLocalVar.Path, exchangeId, exchangeSymbolId);
                Events.ExecuteOnErrorV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse"/>
        /// </summary>
        public partial class V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.ApiResponse, IV1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public V1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetApiResponse(ILogger<MetadataApi> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol? Ok()
            {
                bool suppressDefault = false;
                APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol? result = null;
                OnOk(ref suppressDefault, ref result);
                if (!suppressDefault)
                    result = DefaultOk();
                return result;
            ...
            private APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol? DefaultOk()
            {
                // NOTICE: Consider this AsModel template deprecated. Implement the appropriate partial method instead
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol>(RawContent, _jsonSerializerOptions)
                    : null;
            }

            partial void OnOk(ref bool suppressDefault, ref APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol? result);
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out APIBricks.CoinAPI.MarketDataAPI.REST.V1.Model.MarketDataMetadataSymbol? result)
            {
                result = null;
        ...
        partial void FormatV1SymbolsExchangeIdUnmappedGet(ref string exchangeId, ref Option<int> page, ref Option<int> limit);
        ...
        /// <param name="exchangeId"></param>
        /// <returns></returns>
        private void ValidateV1SymbolsExchangeIdUnmappedGet(string exchangeId)
        {
            if (exchangeId == null)
                throw new ArgumentNullException(nameof(exchangeId));
        }
        ...
        /// <param name="page"></param>
        /// <param name="limit"></param>
        private void AfterV1SymbolsExchangeIdUnmappedGetDefaultImplementation(IV1SymbolsExchangeIdUnmappedGetApiResponse apiResponseLocalVar, string exchangeId, Option<int> page, Option<int> limit)
        {
            bool suppressDefaultLog = false;
            AfterV1SymbolsExchangeIdUnmappedGet(ref suppressDefaultLog, apiResponseLocalVar, exchangeId, page, limit);
            if (!suppressDefaultLog)
                Logger.LogInformation(RestLogEvents.ApiRequestCompleted, "{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="page"></param>
        /// <param name="limit"></param>
        partial void AfterV1SymbolsExchangeIdUnmappedGet(ref bool suppressDefaultLog, IV1SymbolsExchangeIdUnmappedGetApiResponse apiResponseLocalVar, string exchangeId, Option<int> page, Option<int> limit);
        ...
        /// <param name="page"></param>
        /// <param name="limit"></param>
        private void OnErrorV1SymbolsExchangeIdUnmappedGetDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string exchangeId, Option<int> page, Option<int> limit)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorV1SymbolsExchangeIdUnmappedGet(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, exchangeId, page, limit);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(RestLogEvents.ApiRequestFailed, exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="page"></param>
        /// <param name="limit"></param>
        partial void OnErrorV1SymbolsExchangeIdUnmappedGet(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string exchangeId, Option<int> page, Option<int> limit);

        /// <summary>
        /// List symbols not yet mapped to a CoinAPI symbol_id for an exchange. Returns raw exchange symbols that MarketAccess has received (KVP data available) but that have not been mapped to a CoinAPI &#x60;symbol_id&#x60; yet. Since &#x60;symbol_id&#x60; is null for these rows, use &#x60;symbol_id_exchange&#x60; (and &#x60;GET {exchange_id}/by-exchange-symbol/{exchange_symbol_id}&#x60;) to reference them. The &#x60;raw_kvp&#x60; field contains the raw exchange payload as received.
        /// </summary>
        /// <param name="exchangeId">The ID of the exchange.</param>
        /// <param name="page">The page number for pagination (starts from 1). (optional, default to 1)</param>
        /// <param name="limit">Number of records to return per page. (optional, default to 100)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdUnmappedGetApiResponse"/>&gt;</returns>
        public async Task<IV1SymbolsExchangeIdUnmappedGetApiResponse?> V1SymbolsExchangeIdUnmappedGetOrDefaultAsync(string exchangeId, Option<int> page = default, Option<int> limit = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await V1SymbolsExchangeIdUnmappedGetAsync(exchangeId, page, limit, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IV1SymbolsExchangeIdUnmappedGetApiResponse"/>&gt;</returns>
        public async Task<IV1SymbolsExchangeIdUnmappedGetApiResponse> V1SymbolsExchangeIdUnmappedGetAsync(string exchangeId, Option<int> page = default, Option<int> limit = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateV1SymbolsExchangeIdUnmappedGet(exchangeId);

                FormatV1SymbolsExchangeIdUnmappedGet(ref exchangeId, ref page, ref limit);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ...
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/v1/symbols/{exchange_id}/unmapped");
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7Bexchange_id%7D", Uri.EscapeDataString(exchangeId.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        V1SymbolsExchangeIdUnmappedGetApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(Logger, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/symbols/{exchange_id}/unmapped", requestedAtLocalVar, _jsonSerializerOptions);

                                break;
                            }
                        }

                        AfterV1SymbolsExchangeIdUnmappedGetDefaultImplementation(apiResponseLocalVar, exchangeId, page, limit);

                        Events.ExecuteOnV1SymbolsExchangeIdUnmappedGet(apiResponseLocalVar);
            ...
            {
                OnErrorV1SymbolsExchangeIdUnmappedGetDefaultImplementation(e, "/v1/symbols/{exchange_id}/unmapped", uriBuilderLocalVar.Path, exchangeId, page, limit);
                Events.ExecuteOnErrorV1SymbolsExchangeIdUnmappedGet(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="V1SymbolsExchangeIdUnmappedGetApiResponse"/>
        /// </summary>
        public partial class V1SymbolsExchangeIdUnmappedGetApiResponse : APIBricks.CoinAPI.MarketDataAPI.REST.V1.Client.ApiResponse, IV1SymbolsExchangeIdUnmappedGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public V1SymbolsExchangeIdUnmappedGetApiResponse(ILogger<MetadataApi> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
