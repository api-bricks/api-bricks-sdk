...
```php
v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet($exchange_id, $exchange_symbol_id): \OpenAPI\Client\Model\MarketDataMetadataSymbol
```
...
try {
    $result = $apiInstance->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet($exchange_id, $exchange_symbol_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MetadataApi->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
v1SymbolsExchangeIdUnmappedGet($exchange_id, $page, $limit): \OpenAPI\Client\Model\MarketDataMetadataSymbol[]
```
...
try {
    $result = $apiInstance->v1SymbolsExchangeIdUnmappedGet($exchange_id, $page, $limit);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MetadataApi->v1SymbolsExchangeIdUnmappedGet: ', $e->getMessage(), PHP_EOL;
}
```
