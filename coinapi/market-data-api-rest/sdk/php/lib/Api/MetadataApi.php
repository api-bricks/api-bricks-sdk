...
class MetadataApi
{
     ...
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     * @param  string $exchange_symbol_id The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\MarketDataMetadataSymbol
     */
    public function v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet($exchange_id, $exchange_symbol_id, string $contentType = self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'][0])
    {
        list($response) = $this->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetWithHttpInfo($exchange_id, $exchange_symbol_id, $contentType);
        return $response;
    }

    /**
     * Operation v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetWithHttpInfo
     *
     * Get a single symbol by its exchange-native symbol identifier.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return array of \OpenAPI\Client\Model\MarketDataMetadataSymbol, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetWithHttpInfo($exchange_id, $exchange_symbol_id, string $contentType = self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'][0])
    {
        $request = $this->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetRequest($exchange_id, $exchange_symbol_id, $contentType);
    ...
    /**
     * Operation v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsync
     *
     * Get a single symbol by its exchange-native symbol identifier.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsync($exchange_id, $exchange_symbol_id, string $contentType = self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'][0])
    {
        return $this->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsyncWithHttpInfo($exchange_id, $exchange_symbol_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsyncWithHttpInfo
     *
     * Get a single symbol by its exchange-native symbol identifier.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetAsyncWithHttpInfo($exchange_id, $exchange_symbol_id, string $contentType = self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\MarketDataMetadataSymbol';
        $request = $this->v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetRequest($exchange_id, $exchange_symbol_id, $contentType);
    ...
    /**
     * Create request for operation 'v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     * @param  string $exchange_symbol_id The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;). (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGetRequest($exchange_id, $exchange_symbol_id, string $contentType = self::contentTypes['v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'][0])
    {

        // verify the required parameter 'exchange_id' is set
        if ($exchange_id === null || (is_array($exchange_id) && count($exchange_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exchange_id when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'
            );
        }

        // verify the required parameter 'exchange_symbol_id' is set
        if ($exchange_symbol_id === null || (is_array($exchange_symbol_id) && count($exchange_symbol_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exchange_symbol_id when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet'
            );
        }


        $resourcePath = '/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($exchange_symbol_id !== null) {
            $resourcePath = str_replace(
                '{exchange_symbol_id}',
                ObjectSerializer::toPathValue($exchange_symbol_id),
                $resourcePath
            );
        }
     ...
     * @param  int|null $page The page number for pagination (starts from 1). (optional, default to 1)
     * @param  int|null $limit Number of records to return per page. (optional, default to 100)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['v1SymbolsExchangeIdUnmappedGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\MarketDataMetadataSymbol[]
     */
    public function v1SymbolsExchangeIdUnmappedGet($exchange_id, $page = 1, $limit = 100, string $contentType = self::contentTypes['v1SymbolsExchangeIdUnmappedGet'][0])
    {
        list($response) = $this->v1SymbolsExchangeIdUnmappedGetWithHttpInfo($exchange_id, $page, $limit, $contentType);
        return $response;
    }

    /**
     * Operation v1SymbolsExchangeIdUnmappedGetWithHttpInfo
     *
     * List symbols not yet mapped to a CoinAPI symbol_id for an exchange.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return array of \OpenAPI\Client\Model\MarketDataMetadataSymbol[], HTTP status code, HTTP response headers (array of strings)
     */
    public function v1SymbolsExchangeIdUnmappedGetWithHttpInfo($exchange_id, $page = 1, $limit = 100, string $contentType = self::contentTypes['v1SymbolsExchangeIdUnmappedGet'][0])
    {
        $request = $this->v1SymbolsExchangeIdUnmappedGetRequest($exchange_id, $page, $limit, $contentType);
    ...
    /**
     * Operation v1SymbolsExchangeIdUnmappedGetAsync
     *
     * List symbols not yet mapped to a CoinAPI symbol_id for an exchange.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1SymbolsExchangeIdUnmappedGetAsync($exchange_id, $page = 1, $limit = 100, string $contentType = self::contentTypes['v1SymbolsExchangeIdUnmappedGet'][0])
    {
        return $this->v1SymbolsExchangeIdUnmappedGetAsyncWithHttpInfo($exchange_id, $page, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1SymbolsExchangeIdUnmappedGetAsyncWithHttpInfo
     *
     * List symbols not yet mapped to a CoinAPI symbol_id for an exchange.
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1SymbolsExchangeIdUnmappedGetAsyncWithHttpInfo($exchange_id, $page = 1, $limit = 100, string $contentType = self::contentTypes['v1SymbolsExchangeIdUnmappedGet'][0])
    {
        $returnType = '\OpenAPI\Client\Model\MarketDataMetadataSymbol[]';
        $request = $this->v1SymbolsExchangeIdUnmappedGetRequest($exchange_id, $page, $limit, $contentType);
    ...
    /**
     * Create request for operation 'v1SymbolsExchangeIdUnmappedGet'
     *
     * @param  string $exchange_id The ID of the exchange. (required)
     * @param  int|null $page The page number for pagination (starts from 1). (optional, default to 1)
     * @param  int|null $limit Number of records to return per page. (optional, default to 100)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function v1SymbolsExchangeIdUnmappedGetRequest($exchange_id, $page = 1, $limit = 100, string $contentType = self::contentTypes['v1SymbolsExchangeIdUnmappedGet'][0])
    {

        // verify the required parameter 'exchange_id' is set
        if ($exchange_id === null || (is_array($exchange_id) && count($exchange_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exchange_id when calling v1SymbolsExchangeIdUnmappedGet'
            );
        }
        ...
        $resourcePath = '/v1/symbols/{exchange_id}/unmapped';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
