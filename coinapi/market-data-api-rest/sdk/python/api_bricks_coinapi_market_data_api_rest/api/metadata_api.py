...
class MetadataApi:
    ...
    @validate_call
    def v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        exchange_symbol_id: Annotated[StrictStr, Field(description="The exchange-native symbol identifier (`symbol_id_exchange`).")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param exchange_id: The ID of the exchange. (required)
        :type exchange_id: str
        :param exchange_symbol_id: The exchange-native symbol identifier (`symbol_id_exchange`). (required)
        :type exchange_symbol_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get_serialize(
            exchange_id=exchange_id,
    ...
    @validate_call
    def v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get_with_http_info(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        exchange_symbol_id: Annotated[StrictStr, Field(description="The exchange-native symbol identifier (`symbol_id_exchange`).")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MarketDataMetadataSymbol]:
        """Get a single symbol by its exchange-native symbol identifier.
    ...
    @validate_call
    def v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get_without_preload_content(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        exchange_symbol_id: Annotated[StrictStr, Field(description="The exchange-native symbol identifier (`symbol_id_exchange`).")],
        _request_timeout: Union[
    ...
    def _v1_symbols_exchange_id_by_exchange_symbol_exchange_symbol_id_get_serialize(
        self,
        exchange_id,
        exchange_symbol_id,
        _request_auth,
        ...
        if exchange_id is not None:
            _path_params['exchange_id'] = exchange_id
        if exchange_symbol_id is not None:
            _path_params['exchange_symbol_id'] = exchange_symbol_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v1_symbols_exchange_id_unmapped_get(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number for pagination (starts from 1).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None,
        ...
        _param = self._v1_symbols_exchange_id_unmapped_get_serialize(
            exchange_id=exchange_id,
            page=page,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def v1_symbols_exchange_id_unmapped_get_with_http_info(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number for pagination (starts from 1).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None,
    ...
    @validate_call
    def v1_symbols_exchange_id_unmapped_get_without_preload_content(
        self,
        exchange_id: Annotated[StrictStr, Field(description="The ID of the exchange.")],
        page: Annotated[Optional[StrictInt], Field(description="The page number for pagination (starts from 1).")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None,
    ...
    def _v1_symbols_exchange_id_unmapped_get_serialize(
        self,
        exchange_id,
        page,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/symbols/{exchange_id}/unmapped',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
