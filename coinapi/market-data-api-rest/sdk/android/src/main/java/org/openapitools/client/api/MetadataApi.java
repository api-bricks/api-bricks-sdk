...
public class MetadataApi {
  ...
  */
  public MarketDataMetadataSymbol v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet (String exchangeId, String exchangeSymbolId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'exchangeId' is set
    if (exchangeId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'exchangeId' when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet",
        new ApiException(400, "Missing the required parameter 'exchangeId' when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet"));
    }
    // verify the required parameter 'exchangeSymbolId' is set
    if (exchangeSymbolId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'exchangeSymbolId' when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet",
        new ApiException(400, "Missing the required parameter 'exchangeSymbolId' when calling v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet"));
    }

    // create path and map variables
    String path = "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}".replaceAll("\\{" + "exchange_id" + "\\}", apiInvoker.escapeString(exchangeId.toString())).replaceAll("\\{" + "exchange_symbol_id" + "\\}", apiInvoker.escapeString(exchangeSymbolId.toString()));
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (MarketDataMetadataSymbol) ApiInvoker.deserialize(localVarResponse, "", MarketDataMetadataSymbol.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Get a single symbol by its exchange-native symbol identifier.
   * Looks up a symbol by &#x60;symbol_id_exchange&#x60; regardless of mapping status - this also returns symbols that have not been mapped to a CoinAPI &#x60;symbol_id&#x60; yet (see &#x60;{exchange_id}/unmapped&#x60;).
   * @param exchangeId The ID of the exchange.   * @param exchangeSymbolId The exchange-native symbol identifier (&#x60;symbol_id_exchange&#x60;).
  */
  public void v1SymbolsExchangeIdByExchangeSymbolExchangeSymbolIdGet (String exchangeId, String exchangeSymbolId, final Response.Listener<MarketDataMetadataSymbol> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/v1/symbols/{exchange_id}/by-exchange-symbol/{exchange_symbol_id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "exchange_id" + "\\}", apiInvoker.escapeString(exchangeId.toString())).replaceAll("\\{" + "exchange_symbol_id" + "\\}", apiInvoker.escapeString(exchangeSymbolId.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((MarketDataMetadataSymbol) ApiInvoker.deserialize(localVarResponse,  "", MarketDataMetadataSymbol.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Returns raw exchange symbols that MarketAccess has received (KVP data available) but that have not been mapped to a CoinAPI &#x60;symbol_id&#x60; yet. Since &#x60;symbol_id&#x60; is null for these rows, use &#x60;symbol_id_exchange&#x60; (and &#x60;GET {exchange_id}/by-exchange-symbol/{exchange_symbol_id}&#x60;) to reference them. The &#x60;raw_kvp&#x60; field contains the raw exchange payload as received.
   ...
   * @return List<MarketDataMetadataSymbol>
  */
  public List<MarketDataMetadataSymbol> v1SymbolsExchangeIdUnmappedGet (String exchangeId, Integer page, Integer limit) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'exchangeId' is set
    if (exchangeId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'exchangeId' when calling v1SymbolsExchangeIdUnmappedGet",
        new ApiException(400, "Missing the required parameter 'exchangeId' when calling v1SymbolsExchangeIdUnmappedGet"));
    }

    // create path and map variables
    String path = "/v1/symbols/{exchange_id}/unmapped".replaceAll("\\{" + "exchange_id" + "\\}", apiInvoker.escapeString(exchangeId.toString()));
   ...
   * @param exchangeId The ID of the exchange.   * @param page The page number for pagination (starts from 1).   * @param limit Number of records to return per page.
  */
  public void v1SymbolsExchangeIdUnmappedGet (String exchangeId, Integer page, Integer limit, final Response.Listener<List<MarketDataMetadataSymbol>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/v1/symbols/{exchange_id}/unmapped".replaceAll("\\{format\\}","json").replaceAll("\\{" + "exchange_id" + "\\}", apiInvoker.escapeString(exchangeId.toString()));
