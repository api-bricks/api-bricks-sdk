...
namespace CoinAPI.REST.V1.Example
{
    class Program
    {
        ...
        {            
            ...
            Console.Write(Environment.NewLine);
            var orderbooks3_current_data = coinApiEndpointTester.Orderbooks3_current_data_all_filtered_bitstamp().Data;
            ...
            Console.Write(Environment.NewLine);
            var orderbooks3_current_data_btc_usd = coinApiEndpointTester.Orderbooks3_current_data_symbol(symbolId).Data;
